...
/**
 * Provides the local service interface for Exam. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExamLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ExamLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>esami.service.impl.ExamLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the exam local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ExamLocalServiceUtil} if injection and service tracking are not available.
	 */
